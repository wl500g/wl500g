...
char	asc_buffer[180];
	...
	for (i=0; i < size; ) {
		...
		addr++;
		asc_buffer[addr] = 0;
		hex_byte_pack_upper(&hex_buffer[haddr], *p);
		haddr+=2;
		hex_buffer[haddr] = ' ';
		haddr++;
		hex_buffer[haddr] = 0;
...
int	l;
	...
	for (i=0; i < size; ) {
		l = (long) *p;
		hex_buffer[haddr] = hex_asc_upper[(l >> 28) & 0xf];
		haddr++;
		hex_buffer[haddr] = hex_asc_upper[(l >> 24) & 0xf];
		haddr++;
		hex_buffer[haddr] = hex_asc_upper[(l >> 20) & 0xf];
		haddr++;
		hex_buffer[haddr] = hex_asc_upper[(l >> 16) & 0xf];
		haddr++;
		hex_buffer[haddr] = hex_asc_upper[(l >> 12) & 0xf];
		haddr++;
		hex_buffer[haddr] = hex_asc_upper[(l >> 8) & 0xf];
		haddr++;
		hex_buffer[haddr] = hex_asc_upper[(l >> 4) & 0xf];
		haddr++;
		hex_buffer[haddr] = hex_asc_upper[l & 0x0f];
		haddr++;
		hex_buffer[haddr] = ' ';
		haddr++;
		hex_buffer[haddr] = 0;
