 ...
 *    unmapping.
 */
int blk_rq_map_user(struct request_queue *q, struct request *rq, void __user *ubuf,
		    unsigned long len)
{
...
static inline int attempt_back_merge(struct request_queue *q, struct request *rq)
{
...
static inline int attempt_front_merge(struct request_queue *q, struct request *rq)
{
