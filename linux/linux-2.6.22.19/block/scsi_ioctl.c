...
static int __blk_send_generic(struct request_queue *q, struct gendisk *bd_disk, int cmd, int data)
{
	struct request *rq;
	int err;
...
static inline int blk_send_start_stop(struct request_queue *q, struct gendisk *bd_disk, int data)
{
