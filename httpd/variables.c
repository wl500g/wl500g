...
struct variable variables_PrinterStatus[] = {
	...
	{"usb_ftp_pasvenable_x", "", validate_range, ARGV("0","1"), FALSE, FALSE},
	{"usb_ftp_pasvminport_x", "", validate_range, ARGV("1", "65535", ""), FALSE, FALSE},
	{"usb_ftp_pasvmaxport_x", "", validate_range, ARGV("1", "65535", ""), FALSE, FALSE},
