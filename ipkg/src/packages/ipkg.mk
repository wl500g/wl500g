...
#
IPKG_PATCHES=$(IPKG_SOURCE_DIR)/configure.patch $(IPKG_SOURCE_DIR)/opt.patch 

#
# If the compilation of the package requires additional
# compilation or linking flags, then list them here.
#
IPKG_CPPFLAGS="-mips32"
IPKG_LDFLAGS=
...
$(IPKG_IPK): $(IPKG_BUILD_DIR)/.built
	...
	grep -v ^Depends $(IPKG_BUILD_DIR)/familiar/control.in | sed -e "s/@host_cpu@/$(TARGET_ARCH)/" \
		-e "s/@VERSION@/$(IPKG_VERSION)-$(IPKG_IPK_VERSION)/" > $(IPKG_IPK_DIR)/CONTROL/control
