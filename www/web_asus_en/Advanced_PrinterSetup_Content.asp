...
<tr>
		<td class="content_header_td" width="30">Printer Model:</td><td class="content_input_td" width="595"><input type="text" value="<% nvram_get_x("general.log","ProductID"); %>" readonly></td>
</tr>
<tr>
