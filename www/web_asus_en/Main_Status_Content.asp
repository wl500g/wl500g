...
<tr>
<td class="content_header_td">Hardware Version:</td><td class="content_input_td"><input type="text" value="<% nvram_get("HardwareVer"); %>" readonly></td>
</tr>
<tr>
<td class="content_header_td">Boot Loader Version:</td><td class="content_input_td"><input type="text" value="<% nvram_get("BootloaderVer"); %>" readonly></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td class="content_header_td">WAN Port Link State:</td><td class="content_input_td"><input type="text" value="<% nvram_get("IPLink"); %>" readonly></td>
</tr>
<tr>
<td class="content_header_td">WAN Port Connecting Time:</td><td class="content_input_td"><input type="text" value="<% nvram_get("Uptime"); %>" readonly></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('IP address of WAN Interface. If you leave it blank, WL600 will get IP address from DHCP Server automatically');" onMouseOut="return nd();">IP Address:</td><td class="content_input_td"><input type="text" value="<% nvram_get("ExternalIPAddress"); %>" readonly></td>
</tr>
<tr>
<td class="content_header_td">Subnet Mask:</td><td class="content_input_td"><input type="text" value="<% nvram_get("x_ExternalSubnetMask"); %>" readonly></td>
</tr>
<tr>
<td class="content_header_td">Gateway:</td><td class="content_input_td"><input type="text" value="<% nvram_get("x_ExternalGateway"); %>" readonly></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td class="content_header_td">WAN Port Link State:</td><td class="content_input_td"><input type="text" value="<% nvram_get("PPPLink"); %>" readonly></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('IP address of WAN Interface. If you leave it blank, WL600 will get IP address from DHCP Server automatically');" onMouseOut="return nd();">IP Address:</td><td class="content_input_td"><input type="text" value="<% nvram_get("ExternalIPAddress"); %>" readonly></td>
</tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('Status of currently connected printer');" onMouseOut="return nd();">Connected Printer Status:</td><td class="content_input_td"><input type="text" value="<% nvram_get("Status"); %>" readonly></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('User currently use the printer');" onMouseOut="return nd();">User in service:</td><td class="content_input_td"><input type="text" value="<% nvram_get("User"); %>" readonly></td>
</tr>
</table>
</td>
</tr>
