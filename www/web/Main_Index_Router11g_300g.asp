  ...
  <tr bgcolor="#FFFF00"> 
    <td class="content_desc_td_home"> 
      ...
      <ul>
        ...
        <li><b><a href="javascript:top.openBranch('Wireless')">HP_wpa_desc1</a></b> supports up to 54Mbps transmission rate, backward compatibility with 802.11b and interoperable security enhancement.</li>        
        <li><b><a href="javascript:top.openBranch('Router')">Routing Protocol</a></b> support static routing protocol.</li>    
