...
<tr>
<td class="content_header_td" onMouseOver="return overlib('Selecting No disables wireless bridge restriction. Any wireless bridge (including the ones listed in Remote Bridges) will be granted access. Selecting Yes enables wireless bridge restriction. Only those bridges listed in Remote Bridges will be granted access.', LEFT);" onMouseOut="return nd();">Restrict Bridge to MACs below:</td><td class="content_input_td"><input type="radio" value="1" name="WLANConfig11b_x_BRestrict" class="content_input_fd" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_lazywds', '1')" <% nvram_match("wl_lazywds", "1", "checked"); %>>Yes</input><input type="radio" value="0" name="WLANConfig11b_x_BRestrict" class="content_input_fd" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_lazywds', '0')" <% nvram_match("wl_lazywds", "0", "checked"); %>>No</input></td>
</tr>
<tr>
