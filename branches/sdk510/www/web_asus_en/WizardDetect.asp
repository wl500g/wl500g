...
<form name="formname" method="POST">
      <table width="420" height="125" border="0" cellpadding="0" cellspacing="0">
	   ...
	   <td><font face="Arial" color="#000000"><input type="text" size="36" name="PPPConnection_x_WANType" value="<% nvram_get("wan_proto_t"); %>" readonly></font></td>
	</tr>
	<tr>
	   <td height="30"><font face="Arial" color="#000000">Status:</font></td>
	   <td><font face="Arial" color="#000000"><input type="text" size="36" name="PPPConnection_x_WANLink" value="<% nvram_get("wan_status_t"); %>" readonly></font></td>
	</tr>	
	<tr>
	   <td height="30"><font face="Arial" color="#000000">Reason</font></td>
	   <td><font face="Arial" color="#000000">
	   <input type="text" size="36" name="PPPConnection_x_WANStatus" value="<% nvram_get("wan_reason_t"); %>" readonly>
	   <input type="hidden" size="36" name="PPPConnection_x_WANStatusCode" value="<% nvram_get("wan_reasoncode_t"); %>" readonly>
	   </font></td>	   
	</tr>	
	<tr> 
