 ...
 *
 * Copyright (C) 2008-2011 Jean-Francois Moine <http://moinejf.free.fr>
 *
...
static void gspca_release(struct video_device *vfd)
{
	...
	PDEBUG(D_PROBE, "device released");
...
void gspca_disconnect(struct usb_interface *intf)
{
	...
	PDEBUG(D_PROBE, "device disconnect");
